...
@Autonomous(name="NEDaisyDuck", group="")

public class NEDaisyDuck extends LinearOpMode {
    // Declarations
    ...
    public void runOpMode() throws InterruptedException {
        ...
        moveUtils.strafeBuddy(-12,MAX_SPEED,MIN_SPEED,ACCEL);
        acuatorUtils.spinThatDuck(true);
        moveUtils.strafeBuddy(12,MAX_SPEED,MIN_SPEED,ACCEL);
